...
export const FileUploadInput = ({
  ...
  return (
    <InputWrapper
      ...
      <>
        <div className="w-full px-4 py-3 border border-border rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-200 font-montserrat">
